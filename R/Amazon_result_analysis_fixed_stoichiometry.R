...
#### This script is to accompany the AmazonFACE meeting
#### To provide comparison of AmazonFACE CO2 response between variable wood stoichiometry (default) and fixed wood stoichiometry
